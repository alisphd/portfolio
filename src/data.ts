export const cvData = {
  ...
  publications: {
    ...
    submitted: [
      { text: "Ali, S. (2026). Systematic Characterization of Glycine max IQD Genes Reveals Insights into Drought Stress Adaptation and Hormonal Regulation of Plant Architecture. Submitted to 3 Biotech (Springer Nature).", pdfUrl: "#", impactFactor: "2.9 (2024)" },
      { text: "Ali, S., Hanjra, Z., Saeed, M., Fatima, T., Khalil, S., Iltaf, B., & Rashid, M. (2025). Genome-wide identification and comparative characterization of WRKY transcription factors across three cultivated Oryza species reveals lineage-specific regulatory divergence. Submitted to BMC Plant Biology.", pdfUrl: "https://drive.google.com/file/d/1g_hxejY7ex4vHViSB6o_Jp9LCCBN-asv/view?usp=sharing", impactFactor: "4.8 (2024)" },
    ],
    published: [
      { text: "Ali, S. (2026). A V2-SKP1 Interface in Soybean Stay-Green Associated Virus: Evidence from Evolutionary and Structural Analyses. Accepted in Archives of Virology.", pdfUrl: "https://drive.google.com/file/d/1_uf7S324h0PFl0pJNL5xcOhPJ1eraDSm/view?usp=sharing", impactFactor: "2.5 (2024)" },
      { text: "Hanjra, Z., Ali, S., Fatima, T., Saeed, M., Khalil, S., & Rashid, M. (2026). High-resolution comparative genomics and compositional analysis of WRKY transcription factors across seven cereal and model plant genomes. Accepted in BMC Plant Biology.", pdfUrl: "https://drive.google.com/file/d/1MXROO8m3IQNKNp0_tMmaXivHsQmW6IgL/view?usp=sharing", impactFactor: "4.8 (2024)" },
      ...
      { text: "Tufail, M. M., Abbas, H., Khadim, U., Bashir, M. R., Kamran, M., Khan, S. A., Zafar, M., Shahbaz, M. U., ul Haq, M. E., & Ali, S. (2024). Management of Macrophomina phaseolina infecting sesame germplasm. Journal of Phytobiology, 4(1), 9–17.", pdfUrl: "http://researchgate.net/publication/393083884_Management_of_Macrophomina_phaseolina_Infecting_Sesame_Germplasm" }
    ],
    reviews: [
      { text: "Ali, S., Mithal, U., Bibi, J., Hanif, A., Zohaib, M., Asghar, J., ... & Sohail, A. (2025). Revolutionizing Cotton Leaf Curl Disease Detection: CRISPR-Based Diagnostics for Rapid, Field-Deployable Solutions. Planta Animalia, 4(4), 347-362.", pdfUrl: "https://www.researchgate.net/publication/395593235_Revolutionizing_Cotton_Leaf_Curl_Disease_Detection_CRISPR-Based_Diagnostics_for_Rapid_Field-Deployable_Solutions" },
    ...
    conferences: [
      ...
      { text: "Ali, S., Khan, S. A., Abbas, H., Aslam, A., Abbas, W., & Khadim, U. (2023). Evaluation of resistant sources of tomato against early blight under natural field conditions and its management through newly introduced chemicals [Abstract]—8th ICCPS IUB, Pakistan.", pdfUrl: "https://www.researchgate.net/publication/376376249_Evaluation_of_Resistant_Sources_of_Tomato_against_Early_Blight_under_Natural_Field_Conditions_and_its_Management_through_Newly_Introduced_Chemicals" },
