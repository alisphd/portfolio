export const cvData = {
  ...
  publications: {
    ...
    published: [
      { text: "Ali, S. (2026). A V2-SKP1 Interface in Soybean Stay-Green Associated Virus: Evidence from Evolutionary and Structural Analyses. Accepted in Archives of Virology.", pdfUrl: "https://drive.google.com/file/d/1_uf7S324h0PFl0pJNL5xcOhPJ1eraDSm/view?usp=sharing", previewUrl: "papers/v2-skp1-interface-sosgv.pdf", impactFactor: "2.5 (2024)" },
