export const cvData = {
  ...
  publications: {
    summary: "10 research publications and submitted manuscripts, 4 conference presentations",
    submitted: [
      ...
      { text: "Ali, S., & Goh, Hoe-Han. (2026). Multi-Omics Integration for Abiotic Stress Acclimation in Tropical and Underutilized Plants. Submitted to Phyton-International Journal of Experimental Botany.", pdfUrl: "#", previewUrl: "papers/multi-omics-abiotic-stress-tropical-underutilized-plants.pdf" },
    ...
    conferences: [
      ...
      { text: "Aslam, A., Khan, S. A., Ali, S., Abbas, H., Anwar, M., & Ul Haq, U. (2023). Plant growth-promoting rhizobacteria as a biocontrol tool for root-knot nematode killing in lab [Abstract]. 8th ICCPS IUB, Pakistan.", pdfUrl: "#", previewUrl: "papers/pgpr-root-knot-nematode-killing-lab-abstract.pdf" },
      { text: "Ali, S., Khan, S. A., Abbas, H., Aslam, A., Abbas, W., & Khadim, U. (2023). Evaluation of resistant sources of tomato against early blight under natural field conditions and its management through newly introduced chemicals [Abstract]—8th ICCPS IUB, Pakistan.", pdfUrl: "https://www.researchgate.net/publication/376376249_Evaluation_of_Resistant_Sources_of_Tomato_against_Early_Blight_under_Natural_Field_Conditions_and_its_Management_through_Newly_Introduced_Chemicals", previewUrl: "papers/tomato-early-blight-resistant-sources-abstract.pdf" },
      { text: "Ali, S. (2025). Harnessing Host-Induced and Exogenous RNAi for Precision Nematode Control. [Abstract] VIRTUAL NEMATOLOGY CONFERENCE 2025", pdfUrl: "https://drive.google.com/file/d/1JtwWr3s0PDIMVvCwSUyenm9WfIB7CiVN/view?usp=sharing", previewUrl: "papers/rnai-precision-nematode-control-abstract.pdf" }
    ]
  },
  professionalService: [
  ...
  digitalProjects: [
    {
      ...
      thumbnailFile: "bioworkbench-starter.png",
      thumbnailAlt: "BioWorkbench Starter project page preview",
      highlights: [
